    ...
    <div style={{minHeight:"100vh",background:G.bg,color:G.text,fontFamily:"'Jost',sans-serif"}}>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .photo-upload{border:2px dashed ${G.border};border-radius:12px;padding:24px;text-align:center;cursor:pointer;transition:all .18s;background:rgba(255,255,255,.5)}
        .photo-upload:hover{border-color:${G.terracotta};background:rgba(255,255,255,.8)}
        .lightbox{position:fixed;inset:0;background:rgba(0,0,0,.9);display:flex;align-items:center;justify-content:center;z-index:300;cursor:zoom-out}
      ...
      {page==="inventory"&&view==="detail"&&selItem&&(()=>{
        ...
        return(
          <div style={{maxWidth:660,margin:"0 auto",padding:"28px 24px"}} className="slide">
            {item.photo&&(
              <div style={{borderRadius:16,overflow:"hidden",marginBottom:20,cursor:"zoom-in",maxHeight:320,boxShadow:"0 8px 24px rgba(139,90,43,.2)"}} onClick={()=>setLightbox(item.photo)}>
